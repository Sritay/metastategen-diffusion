...
#SBATCH --qos=gpu-shd
#SBATCH --account=e760
#SBATCH --job-name=msgen-al-21
#SBATCH --time=12:00:00
#SBATCH --output=slurm-88-%j.out
#SBATCH --error=slurm-88-%j.err
...
singularity exec --cleanenv \
  ...
  bash -lc "
    ...
    echo 'Running Active Learning Loop 21 (Verified Fixes)...'
    \$PY_EXE scripts/run_al_loop.py --config configs/ala2_al_21_hpc.yaml
  "
