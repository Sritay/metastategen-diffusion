...
singularity exec --cleanenv \
  ...
  bash -lc "
    ...
    echo 'Running Loop 23 Refinement (Post-Chirality Fix)...'
    # Uses Loop 23 Diffusion Model (Fixed Chirality) + Pairwise Force Surrogate
    ...
    \$PY_EXE scripts/sample_refined.py \\
      ...
      --out-dir runs/loop_b_refinement_23 \\
      --n-samples 10000 \\
      --batch-size 1000 \\
      --warmup-steps 1000 \\
      --keep-percent 0.01 \\
