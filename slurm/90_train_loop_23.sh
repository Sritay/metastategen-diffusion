...
#SBATCH --qos=gpu-shd
#SBATCH --account=e760
#SBATCH --job-name=msgen-al-23
#SBATCH --time=12:00:00
#SBATCH --output=slurm-90-%j.out
#SBATCH --error=slurm-90-%j.err
...
singularity exec --cleanenv \
  ...
  bash -lc "
    ...
    echo 'Running Active Learning Loop 23 (Forced Chiral Projection)...'
    \$PY_EXE scripts/run_al_loop.py --config configs/ala2_al_23_hpc.yaml
  "
