...
#SBATCH --qos=gpu-shd
#SBATCH --account=e760
#SBATCH --job-name=msgen-al-18
#SBATCH --time=12:00:00
#SBATCH --output=slurm-85-%j.out
#SBATCH --error=slurm-85-%j.err
...
singularity exec --cleanenv \
  ...
  bash -lc "
    ...
    echo 'Running Active Learning Loop 18 (Chiral Conditioning + Scaled Features Fix)...'
    \$PY_EXE scripts/run_al_loop.py --config configs/ala2_al_18_hpc.yaml
  "
