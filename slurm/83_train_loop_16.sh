...
#SBATCH --qos=gpu-shd
#SBATCH --account=e760
#SBATCH --job-name=msgen-al-16
#SBATCH --time=12:00:00
#SBATCH --output=slurm-83-%j.out
#SBATCH --error=slurm-83-%j.err
...
singularity exec --cleanenv \
  ...
  bash -lc "
    ...
    echo 'Running Active Learning Loop 16 (Chirality Boosted + Bond Fix)...'
    \$PY_EXE scripts/run_al_loop.py --config configs/ala2_al_16_hpc.yaml
  "
