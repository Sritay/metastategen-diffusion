...
singularity exec --cleanenv \
  ...
  bash -lc "
    ...
    echo 'Running Active Learning Loop 24 (Fixed Diffusion Params)...'
    \$PY_EXE scripts/run_al_loop.py --config configs/ala2_al_24_hpc.yaml
  "
