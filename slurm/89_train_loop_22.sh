...
#SBATCH --qos=gpu-shd
#SBATCH --account=e760
#SBATCH --job-name=msgen-al-22
#SBATCH --time=12:00:00
#SBATCH --output=slurm-89-%j.out
#SBATCH --error=slurm-89-%j.err
...
singularity exec --cleanenv \
  ...
  bash -lc "
    ...
    echo 'Running Active Learning Loop 22 (New Edge Architecture)...'
    \$PY_EXE scripts/run_al_loop.py --config configs/ala2_al_22_hpc.yaml
  "
