...
#SBATCH --qos=gpu-shd
#SBATCH --account=e760
#SBATCH --job-name=msgen-al-17
#SBATCH --time=12:00:00
#SBATCH --output=slurm-84-%j.out
#SBATCH --error=slurm-84-%j.err
...
singularity exec --cleanenv \
  ...
  bash -lc "
    ...
    echo 'Running Active Learning Loop 17 (Chirality Conditioning)...'
    \$PY_EXE scripts/run_al_loop.py --config configs/ala2_al_17_hpc.yaml
  "
