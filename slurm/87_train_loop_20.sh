...
#SBATCH --qos=gpu-shd
#SBATCH --account=e760
#SBATCH --job-name=msgen-al-20
#SBATCH --time=12:00:00
#SBATCH --output=slurm-87-%j.out
#SBATCH --error=slurm-87-%j.err
...
singularity exec --cleanenv \
  ...
  bash -lc "
    ...
    echo 'Running Active Learning Loop 20 (Explicit Chiral Volume Fix)...'
    \$PY_EXE scripts/run_al_loop.py --config configs/ala2_al_20_hpc.yaml
  "
