...
#SBATCH --qos=gpu-shd
#SBATCH --account=e760
#SBATCH --job-name=msgen-al-15
#SBATCH --time=12:00:00
#SBATCH --output=slurm-82-%j.out
#SBATCH --error=slurm-82-%j.err
...
singularity exec --cleanenv \
  ...
  bash -lc "
    ...
    echo 'Running Active Learning Loop 15 (Chiral Fix + Bond Fix REPAIRED)...'
    \$PY_EXE scripts/run_al_loop.py --config configs/ala2_al_15_hpc.yaml
  "
